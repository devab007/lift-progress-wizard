  ...
  head: () => ({
    meta: [
      ...
      { title: "Grind — Smart Progressive Overload Tracker" },
      {
        name: "description",
        content:
          "Grind calculates the exact load for your next set from your training history. Offline-first gym logging, PRs and analytics.",
      },
      { property: "og:title", content: "Grind — Smart Progressive Overload Tracker" },
      {
        property: "og:description",
        content: "Track sets, get progressive overload recommendations, break records.",
      },
